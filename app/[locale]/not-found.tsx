...
const notFoundCopyByLocale: Record<
  Locale,
  {
    badgeLabel: string
    title: string
...
> = {
  es: {
    ...
    title: "Esta página salió del mapa.",
    description:
      "La ruta que intentaste abrir no existe, cambió o todavía no forma parte de la red de Solana Venezuela. Puedes volver al inicio, explorar recursos o retomar el camino desde la comunidad.",
    primaryCtaLabel: "Volver al inicio",
    secondaryCtaLabel: "Explorar recursos",
    supportLabel:
      "Si llegaste aquí desde un enlace antiguo o compartido, vuelve a la portada y navega desde el menú principal para encontrar la ruta correcta.",
    panelTitle: "Rutas disponibles para volver a la red.",
    panelDescription:
  ...
  en: {
    ...
    description:
      "The route you tried to open does not exist, changed, or is not yet part of the Solana Venezuela network. You can head back home, explore resources, or get back on track from the community.",
    primaryCtaLabel: "Back to home",
    secondaryCtaLabel: "Explore resources",
    supportLabel:
      "If you landed here from an old or shared link, head back to the homepage and use the main navigation to find the right route.",
    panelTitle: "Routes available to get back into the network.",
    panelDescription:
      "Quick shortcuts to stay inside the ecosystem without losing context.",
    quickLinks: [
      {
        title: "Home",
        description: "Return to the main Solana Venezuela homepage.",
        href: "/",
        icon: HomeIcon,
        accentClass: "text-primary",
      },
      {
        title: "Resources",
        description: "Explore learning material, videos, and builder spaces.",
        href: "/#recursos",
        icon: CompassIcon,
        accentClass: "text-secondary",
      },
      {
        title: "Community",
        description: "Open the form to join the Venezuela chapter.",
        href: "/#membership-form",
        icon: UsersRoundIcon,
        accentClass: "text-tertiary",
      },
...
export default function NotFound() {
  ...
  const content = notFoundCopyByLocale[locale]
              ...
              <CardContent className="px-6 pb-6 sm:px-8 sm:pb-8">
                ...
                <div className="mt-6 rounded-[1.5rem] border border-white/8 bg-white/3 px-5 py-4">
                  <p className="text-[0.72rem] uppercase tracking-[0.28em] text-primary">
                    {homeContent.siteName}
                  </p>
                  <p className="mt-3 text-sm leading-6 text-white/72">{homeContent.siteTagline}</p>
                </div>
              </CardContent>
            </Card>
          </Reveal>
